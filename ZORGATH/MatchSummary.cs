...
public class MatchSummary
{
    ...
    public MatchSummary(MatchResults matchResults, string winningTeam, string replayServerUrl)
    {
        ...
        // LegacyReplayUrl
        Size = matchResults.file_size <= 0 ? 1 : matchResults.file_size; // Make sure file size is > 0.
